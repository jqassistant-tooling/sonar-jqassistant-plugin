...
== Installation
* https://search.maven.org/#search%7Cga%7C1%7Cg%3A%22org.jqassistant.contrib.sonarqube%22%20AND%20v%3A%221.0.0%22[Download] the plugin JAR for your SonarQube release
